  ...
  if (editing) {
    return (
      <input
        ...
        className="text-[11px] font-semibold px-2 py-0.5 rounded-full outline-none w-36 font-sans"
        style={{
  ...
  if (value) {
    return (
      <button
        ...
        title={value}
        className="text-[11px] font-semibold px-2 py-0.5 rounded-full truncate max-w-[140px] shrink-0"
