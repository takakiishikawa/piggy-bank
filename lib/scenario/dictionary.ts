...
export const DICT = {
  ja: {
    ...
    mizuhoOpenBank: "みずほダイレクトを開く",
    mizuhoChooseFile: "CSVファイルを選択",
    mizuhoImporting: "取込中…",
    mizuhoImportDone: "{imported}件を取り込みました(重複{skipped}件、入金{deposits}件・対象外{excluded}件は取り込みません)",
  ...
  en: {
    ...
    mizuhoOpenBank: "Open Mizuho Direct",
    mizuhoChooseFile: "Choose CSV file",
    mizuhoImporting: "Importing…",
    mizuhoImportDone: "Imported {imported} (skipped {skipped} duplicates; ignored {deposits} deposits and {excluded} excluded)",
